        ...
        <div className="rounded-3xl auth-card p-8 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {errors.password && (
                <span className="text-[10px] text-rose-450 font-medium ml-1">{errors.password}</span>
              )}
            </div>
          ...
          <div className="relative w-full max-w-[380px] mx-auto min-h-[46px] group cursor-pointer">
            ...
            <div id="google-signin-btn" className="opacity-0 absolute inset-0 z-10 w-full h-full [&_iframe]:w-full [&_iframe]:h-full [&_iframe]:cursor-pointer cursor-pointer" />
          </div>
