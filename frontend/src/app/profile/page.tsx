  ...
  if (authLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-3">
        ...
        <p className="text-xs font-bold text-muted-foreground">Loading profile...</p>
      </div>
    );
  }
  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4 gap-4 max-w-md mx-auto">
        ...
        <h2 className="text-xl font-black text-foreground">Access your profile</h2>
        <p className="text-xs text-muted-foreground leading-relaxed">
          Sign in to view your ratings, active items listed, and manage your account configurations.
        </p>
        <Link
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="rounded-3xl border border-border/40 bg-card p-5 shadow-sm flex flex-col gap-4">
            ...
            {isVerified ? (
              ...
              <>
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-[10px] text-muted-foreground mt-0.5 font-semibold">Upload ID documents to rent higher value gear.</p>
                </div>
              </>
            )}
          </div>
          ...
          {!isVerified && (
            <Link
              href="/verification"
              className="w-full py-2.5 bg-primary hover:brightness-110 text-white font-extrabold rounded-xl transition-all duration-200 text-xs tracking-wide active:scale-95 text-center cursor-pointer shadow-sm"
            >
              Verify Identity Now
            </Link>
          )}
        ...
        <div className="rounded-3xl border border-border/40 bg-card p-5 shadow-sm flex flex-col gap-4 md:col-span-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-muted/20 border border-border/20 p-4 rounded-2xl col-span-2 sm:col-span-1">
              ...
              <p className="text-[9px] text-muted-foreground mt-0.5 font-semibold">Based on owner reviews</p>
            </div>

          </div>

          <div className="flex items-center justify-between border-t border-border/20 pt-4 mt-2">
            <span className="text-xs text-muted-foreground font-semibold">Add a new rental listing</span>
            <Link
              href="/create-listing"
              className="flex items-center gap-1 px-4 py-2 bg-primary hover:brightness-110 text-white font-extrabold rounded-xl transition-all duration-200 text-xs shadow-sm active:scale-95"
            >
